...
function AfterHeader() {
    return (
        ...
        <div className="hidden max-lg:block relative top-36 bg-cover w-[610px]">
        <Image src={Legal1} alt="FG_LOGO" height="220" className=" relative w-[610px]" />
        </div>
        <div className="bg-[#332b27] md:hidden top-[8.6rem] h-[22rem] relative w-[610px]">
