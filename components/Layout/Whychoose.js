...
function WhyChoose() {
    return (
        <>
            ...
            <div className="hidden max-lg:block top-[35rem] bg-why-choose relative w-[505px]">
            

            <Image src={why_choose} alt="whychoose" width="100%" className="relative bottom-[12.8rem] h-[505px]" />
